...
const DeckdeckgoHighlightCode = class {
  ...
  render() {
    ...
    return (Object(_index_5142f31b_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_5142f31b_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: hostClass, onClick: () => this.edit() }, this.renderCarbon(), this.renderUbuntu(), Object(_index_5142f31b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "deckgo-highlight-code-container" }, Object(_index_5142f31b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("code", { contentEditable: this.editable, onBlur: () => this.applyCode(), onKeyDown: ($event) => this.catchTab($event), ref: (el) => (this.refCode = el) }), Object(_index_5142f31b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "code" }))));
  }
  renderCarbon() {
    if (this.terminal !== _deckdeckgo_highlight_code_carbon_theme_e63d6e0d_js__WEBPACK_IMPORTED_MODULE_1__["D"].CARBON) {
      return undefined;
